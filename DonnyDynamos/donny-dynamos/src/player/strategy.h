...
public:
    ...
    static const std::string OFFENSE_FORMATION_OVERLAPPING_CONF;
    static const std::string OFFENSE_FORMATION_FALSENINE_CONF;
    static const std::string DEFENSE_FORMATION_442BLOCK_CONF;
    static const std::string OFFENSE_FORMATION_INVERTEDFB_CONF;
    static const std::string DEFENSE_FORMATION_433PRESS_CONF;
...
private:
    ...
    rcsc::Formation::Ptr M_offense_formation_overlapping;
    rcsc::Formation::Ptr M_offense_formation_falsenine;
    rcsc::Formation::Ptr M_defense_formation_442block;
    rcsc::Formation::Ptr M_offense_formation_invertedFB;
    rcsc::Formation::Ptr M_defense_formation_433press;
